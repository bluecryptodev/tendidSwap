      ...
      return (
        <>
          {poolId === PoolIds.poolBasic && (
            <FooterEntry label="Max. LP token entry" value={maxLpTokens} />
          )}
          <FooterEntry label="Funds to raise:" value={ifo[poolId].raiseAmount} />
          <FooterEntry label="CAKE to burn:" value={ifo[poolId].cakeToBurn} />
      ...
      return (
        <>
          ...
          {poolId === PoolIds.poolUnlimited && (
            <FooterEntry label="Additional fee:" value={taxRate} />
          )}
          <FooterEntry label="Total committed:" value={totalCommitted} />
        </>
      )
    }
    if (status === 'finished') {
