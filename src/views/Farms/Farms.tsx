...
const Farms: React.FC = () => {
  ...
  const rowData = farmsStakedMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('TENDIE', '')
  ...
  return (
    <>
      ...
      <Page>
        ...
        {renderContent()}
        <div ref={loadMoreRef} />
        <StyledImage src="/images/tendie-farm.png" alt="Tendie illustration" width={120} height={103} />
      </Page>
    </>
  )
}
